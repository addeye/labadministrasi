  ...
  <div class="modal-body">
    <div class="form-group">      
      <select name="id_mahasiswa" class="form-control">
        ...
        <?php $quemhs=mysql_query("SELECT * FROM tbmahasiswa");
        while($m=mysql_fetch_array($quemhs)){
          ?>
          <option value="<?=$m['id_mahasiswa']?>" <?php if($m['id_mahasiswa']==$id_mahasiswa){echo "selected";} ?> ><?=$m['nim']?> <?=$m['nama']?></option>
          <?php } ?>
        </select>
      </div>
